...
?>
		<table class="table">
			...
			?>
			<tr>
				<td><input type="hidden" name="id" value="<?php echo $Reclamation['ID_reclamation']; ?>"><?php echo $Reclamation['ID_reclamation']; ?></td>
				<td><input type="hidden" name="cn" value="<?php echo $Reclamation['Contenu']; ?>"><?php echo $Reclamation['Contenu']; ?></td>
				<td><input type="hidden" name="ps" value="<?php echo $Reclamation['ID_utilisateur']; ?>"><?php echo $Reclamation['ID_utilisateur']; ?></td>
				<td><input type="hidden" name="tp" value="<?php echo $Reclamation['Type_paiement']; ?>"><?php echo $Reclamation['Type_paiement']; ?></td>
                <td><input type="hidden" name="id" value="<?php echo $Reclamation['Etat']; ?>"><?php echo $Reclamation['Etat']; ?></td>
			<td>
                 
                <?php
                echo'
                <p><button  type ="submit" class="btn btn-info"><a href="modifierReclamation.php? id='.$Reclamation['ID_reclamation'].'"  class="text-light"> Traiter</a> </button>
