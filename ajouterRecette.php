...
<body>
  ...
  <li class="sidebar-item">
        ...
        <div class="page-wrapper">
           ...
           <form name="f" action="ajouterRecette.php" method="POST" id="myForm">
  <div class="container">
<br>
<br>
  ...
  <div class="">
    ...
    <input type="text"  name="nom_rec" class="form-control" id="nom_rec">
    <span id="error" style="color:#FF0000"></span>
  </div>
  <div class="">
    <label for="exampleInputPassword1" class="">type_rec:</label>
    <input type="text"  name="type_rec" class="form-control" id="type_rec">
    <span id="error2" style="color:#FF0000"></span>
  </div>
    <div class="">
    <label for="exampleInputPassword1" class="">ingredient_rec:</label>
    <input type="text"  name="ingredient_rec" class="form-control" id="ingredient_rec">
  </div>
  <div class="">
