...
<body>
                    ...
                    <ul class="navbar-nav ms-auto d-flex align-items-center">
                        ...
                        <li>
                            <a class="profile-pic" href="#">
                                <img src="C:/xampp/htdocs/projet/icon/achref.png" alt="user-img" width="50"
  ...
  <li class="sidebar-item">
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Gestion type</h4>
                    </div>
           ...
           <form name="f" action="ajouterType.php" method="POST" id="myForm">
  <div class="container">
<br>
<br>
  
    <!--<input type="text" name="id" class="form-control" id="" aria-describedby="emailHelp">-->
  ...
  <div class="">
    <label for="exampleInputPassword1" class="">Nom_type:</label>
    <input type="text"  name="nom_type" class="form-control" id="nom_type">
...
<script> let myForm = document.getElementById('myForm');
    ...
    myForm.addEventListener('submit', function(e){
        let myInput = document.getElementById('id_type');
        let myInput2 = document.getElementById('nom_type');
        let myRegex = /^[0-9]+$/; 
    ...
    if(myInput.value.trim() == "" || !myRegex.test(myInput.value) ) {
        ...
        myError.innerHTML = "le champ comporte uniquement des chiffres.";
