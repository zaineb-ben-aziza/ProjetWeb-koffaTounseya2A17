...
?>
  ...
  <button class="btn btn-danger"><a href="supprimer_promos.php? deletevar='.$promos['codepr'].'" class="text-light">Supprimer</a></button>
...
<!-- =========================END PHP===================================== -->
	...
	<form  name="f" action="impression_promo.php" method="POST">
