...
<body>
  ...
  <path fill-rule="evenodd" d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z"/>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="afficherType.php"
                                aria-expanded="false">
                                <i class="fa fa-user" aria-hidden="true"></i>
                                <span class="hide-menu">Gestion des types</span>
                            </a>
                        </li>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            ...
                            <a href="../projet/front_kol/front_a.php" target="_blank"
  ...
  <div class="container">
<button  type ="submit" class="btn btn-primary my-5"><a href="ajouterRecette.php"  class="text-light"> Ajouter une recette</a> </button>
 <!-- =======================recherche======================================= -->
 <form method="POST" action="recherche.php"  name="f"  class="container-fluid">
 ...
 <input type="SUBMIT" value="chercher" class="btn btn-success" name="chercher">
		...
		<table class="table">
			...
			<tr>
				<td><?php echo $Recette_r['id'];  ?> </td>
				<td><?php echo $Recette_r['nom_rec']; ?>  </td>
				<td><?php echo $Recette_r['type_rec']; ?></td>
				<td><?php echo $Recette_r['ingredient_rec']; ?></td>
                <td><?php echo $Recette_r['description']; ?></td>
                <td><?php echo $Recette_r['id_type']; ?></td>
 ...
 <?php 
 echo  '            	
<button class="btn btn-info"><a href="modifierRecette.php? ach='.$Recette_r['id'].'" class="text-light">Update </a> </button>
<button class="btn btn-danger"><a href="supprimerRecette.php? deletevar='.$Recette_r['id'].'" class="text-light">Delete</a> </button>';
     }?>
    </td>  
	</tr> 
		</table>
