...
?>
  ...
  <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
    <script type="text/javascript">
      ...
      function drawChart() {
        var data = google.visualization.arrayToDataTable([
          ['Genre', 'Age'],
          ['Enfant', <?php echo $UtilisateurC->getenfant() ?>],
          ['Adulte',  <?php echo $UtilisateurC->getadulte() ?>],
          ['Vieux', <?php echo $UtilisateurC->getvieux() ?>]
        ]);
   ...
   easing: 'out'
          ...
          title: 'Categories des utilisateurs classés par age',
          is3D: true
        };
    ...
    function drawChart() {
      var data = google.visualization.arrayToDataTable([
        ["Client", "Nouveau utilisateurs", { role: "style" } ],
        ["<?php echo $year;?>",<?php echo $UtilisateurC->getannees($year) ?>, "color: red"],
        ["<?php echo $year-1;?>", <?php echo $UtilisateurC->getannees($year-1) ?> , "color:blue"],
        ["<?php echo $year-2;?>", <?php echo $UtilisateurC->getannees($year-2) ?> , "#ff9c04"],
      ]);
      ...
      var options = {
        backgroundColor: 'transparent',
        title: "Les nouveaux utilisateur pendant ces 3 derniers Anneés",
        width: 600,
        height: 430,
        bar: {groupWidth: "95%"},
