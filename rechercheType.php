...
<button  type ="submit" class="btn btn-primary my-5"><a href="ajouterType.php"  class="text-light"> Ajouter un type</a> </button>
 <!-- =======================e======================================= -->
 <?php
include_once 'C:/xampp/htdocs/projet2/typeC.php';
...
<button class="btn btn-info"><a href="modifierRecette.php? ach='.$Type['id_type'].'" class="text-light">Modifier</a></button>
<button class="btn btn-danger"><a href="supprimerRecette.php? deletevar='.$Type['id_type'].'" class="text-light">Delete</a></button>
