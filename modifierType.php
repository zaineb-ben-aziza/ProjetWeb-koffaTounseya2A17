<?php
include_once "$_SERVER[DOCUMENT_ROOT]/projet2/typeC.php";
$Type = null;
$error='';
 ...
 if (
    ...
    )
  {
     if (
         ...
         $TypeC->modifiertype($Type,$_GET['ach']);
...
<body>
  ...
  <li class="sidebar-item">
        ...
        <div class="page-wrapper">
            ...
            <?php $TypeC=new  TypeC();
$listetype=$TypeC->click_type ($_GET['ach']);
...
<br>
  ...
  <div class="">
    ...
    <input type="text"  name="id_type" class="form-control" id="id_type" value="<?php echo $Type_r['id_type'];?>">
    <span id="error"></span>
  </div>
  <div class="">
    <label for="exampleInputPassword1" class="">nom_type:</label>
    <input type="text"  name="nom_type" class="form-control" id="nom_type" value="<?php echo $Type_r['nom_type'];}?>">
    <span id="error2"></span>
  </div>
...
<script> let myForm = document.getElementById('myForm');
    ...
    if(myInput.value.trim() == "" || !myRegex.test(myInput.value) ) {
        ...
        myError.innerHTML = "le champ  comporte uniquement des lettres et des tirets.";
