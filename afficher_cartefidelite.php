...
<body>
  ...
  <path fill-rule="evenodd" d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z"/>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="afficher_cartefidelite.php"
                                aria-expanded="false">
                                <i class="fa fa-user" aria-hidden="true"></i>
                                <span class="hide-menu">Gestion  carte de fidilite</span>
                            </a>
                        </li>
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Gestion  carte de fidelite</h4>
                    </div>
  ...
  <div class="container">
<button  type ="submit" class="btn btn-primary my-5"><a href="ajouter_cartefidelite.php"  class="text-light"> Ajouter une carte de fidelite</a> </button>
 <!-- =======================PHP======================================= -->
<?php
    include 'C:/xampp/htdocs/projet/carte_fideliteC.php';
	$carte_fidiliteC=new carte_fidiliteC();
	$listefidilite=$carte_fidiliteC->afficher_cartefidilite(); 
...
?>
		...
		<table class="table">
			...
			<?php
				foreach($listefidilite as $carte_fidiliteC){
			?>
			<tr>
				<td><?php echo $carte_fidiliteC['id']; ?></td>
				<td><?php echo $carte_fidiliteC['point']; ?></td>
				
			<td><?php
                echo  '
			<button class="btn btn-info"><a href="modifier_cartefidelite.php? deletevar='.$carte_fidiliteC['id'].'" class="text-light" name="modifier">Modifier </a></button>
  <button class="btn btn-danger"><a href="supprimer_cartefidelite.php? deletevar='.$carte_fidiliteC['id'].' " class="text-light">Supprimer</a></button>
		</td>';
				?>
                </td>
			</tr>
