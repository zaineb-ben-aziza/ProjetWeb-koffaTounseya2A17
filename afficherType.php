                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            ...
                            <a href="frontRecette.html" target="_blank"
...
<button  type ="submit" class="btn btn-primary my-5"><a href="ajouterType.php"  class="text-light"> Ajouter un type</a> </button>
 <!-- =======================recherche======================================= -->
 <form method="POST" action="rechercheType.php"  name="f"  class="container-fluid">
 ...
 <input type="SUBMIT" value="chercher" class="btn btn-success" name="chercher">
		...
		<table class="table">
			...
			<?php
				foreach($listetype as $type_r){
                    
                    
			?>

			<tr>
            <td><?php echo $type_r['id_type']; ?></td>
				<td><?php echo $type_r['nom_type'];  ?> </td>
 ...
 <?php 
 echo  '            	
<button class="btn btn-info"><a href="modifierType.php? ach='.$type_r['id_type'].'" class="text-light">Update </a> </button>
<button class="btn btn-danger"><a href="supprimerType.php? deletevar='.$type_r['id_type'].'" class="text-light">Delete</a> </button>';
     }?>
    </td>  
	</tr> 
		</table>
