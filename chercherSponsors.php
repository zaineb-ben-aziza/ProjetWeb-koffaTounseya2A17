...
<body>
  ...
  <path fill-rule="evenodd" d="M7.293 1.5a1 1 0 0 1 1.414 0l6.647 6.646a.5.5 0 0 1-.708.708L8 2.207 1.354 8.854a.5.5 0 1 1-.708-.708L7.293 1.5z"/>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="afficherEvenement.php"
                                aria-expanded="false">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Gestion des sponsors</h4>
                    </div>
  ...
  <div class="container">
<button  type ="submit" class="btn btn-primary my-5"><a href="afficherSponsors.php"  class="text-light"> Ajouter un ingrédient</a> </button>
 <!-- =======================PHP======================================= -->
 <?php
include_once "$_SERVER[DOCUMENT_ROOT]/projet2/SponsorsC.php";
if(isset($_POST['chercher'])){
$Sponsors=new SponsorsC();
$listeSponsors=$Sponsors->chercherSponsors($_POST["id_Sponsors"]);
...
echo '
<tr>
<td>'.$Sponsors['id_Sponsors'].' </td>
<td>'.$Sponsors['Nom_Sponsors'].' </td>
<td>'.$Sponsors['Marque'].' </td>
<td>'.$Sponsors['Numero'].' </td>
<td> '.$Sponsors['Adresse_mail'].' </td>

<td>

<button class="btn btn-info"><a href="modifierSponsors.php? deletevar='.$Sponsors['id_Sponsors'].'" class="text-light">Modifier</a></button>
  <button class="btn btn-danger"><a href="supprimerSponsors.php? deletevar='.$Sponsors['id_Sponsors'].'" class="text-light">Delete</a></button>
