...
<body>
  ...
  <li class="sidebar-item">
        ...
        <div class="page-wrapper">
           ...
           <form name="f" action="ajouterReclamation.php" method="POST" id="myForm">
  <div class="container">
<br>
<br>
  ...
  <div class="">
    ...
    <input type="text"  name="Type_paiement" class="form-control" id="Paiement">
    <span id="error_paiement" class="spans"></span>
  </div> 
  <br>
