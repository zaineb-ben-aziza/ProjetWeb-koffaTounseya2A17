...
<?php $CommentaireC = new CommentaireC();
    $liste=$CommentaireC->click_commentaire ($_GET['id']);
...
<br>
  ...
  <div class="">
    ...
    <input type="text"  name="Contenu" class="form-control" id="" value = "<?php echo $Commentaire['Contenu']; ?>">
  </div>
    <div class="">
    <label for="exampleInputPassword1" class="">Pseudonyme:</label>
    <input type="text"  name="Pseudonyme" class="form-control" id="" value = "<?php echo $CommentaireC -> afficherPseudonyme($Commentaire['ID_utilisateur']); ?>">
  </div>
  <div class="">
    <label for="exampleInputPassword1" class="">Type</label>
    <input type="number"  name="Avis" class="form-control" id="" value = "<?php echo $Commentaire['Avis'];} ?>">
  </div> 
  <br>
