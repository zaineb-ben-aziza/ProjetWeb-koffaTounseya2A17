...
if (isset($_POST['Contenu']) &&
    ...
    isset($_POST['Avis'])){
        ...
        !empty($_POST['Avis'])) {
            $Commentaire = new Commentaire($_POST['Contenu'], $_POST['Pseudonyme'], $_POST['Avis']);
...
<body>
  ...
  <li class="sidebar-item">
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Gestion Commentaires</h4>
                    </div>
           ...
           <form name="f" action="ajouterCommentaire.php" method="POST" id="myForm">
  <div class="container">
<br>
<br>
  ...
  <!-- <div class="">
    <label for="exampleInputPassword1" class="">ID Commentaire:</label>
    <input type="number"  name="ID_Commentaire" class="form-control" id="">
  </div> -->
  <div class="">
    <label for="exampleInputPassword1" class="">Contenu:</label>
    <input type="text"  name="Contenu" class="form-control" id="Contenu">
    <span id="error_contenu" class="spans"></span>
  </div>
    <div class="">
    <label for="exampleInputPassword1" class="">Pseudonyme:</label>
    <input type="text"  name="Pseudonyme" class="form-control" id="Pseudonyme">
    <span id="error_pseudo" class="spans"></span>
  </div>
  <div class="">
    <label for="exampleInputPassword1" class="">Avis:</label>
    <input type="number"  name="Avis" class="form-control" id="Avis">
    <span id="error_Avis" class="spans"></span>
  </div> 
  <br>
...
<?php echo $error; ?>
    ...
    let myInput = document.getElementById('Contenu');
    let myInputP = document.getElementById('Pseudonyme');
    let myRegex = /^[a-zA-Z-\s]+$/;  
    
    
    
    let myError = document.getElementById('error_contenu');
    let myError2 = document.getElementById('error_pseudo');
    ...
    if(myInput.value.trim() == "")  {
        myError.innerHTML = "le champ Contenu est requis.";
        myError.style.color = 'red';
        e.preventDefault();
      }if (myRegex.test(myInputP.value) == false) {  
