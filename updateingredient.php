...
<br>
  <div class="">
    ...
    <input type="hidden" name="codeing" class="form-control" id="" aria-describedby="emailHelp">
...
<p><input type="submit"  value="Modifier" class="btn btn-info"  name="modifier" onclick="return verif()">&nbsp;
