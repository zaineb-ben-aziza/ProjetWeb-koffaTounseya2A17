<?php
    include "$_SERVER[DOCUMENT_ROOT]/projet2/recetteC.php";
...
$listerecette=$Recette->chercherID($_POST["code"]);
echo'
<table class="table">
...
<tr>
       <td> '.$Recette['id'].'  </td>
				<td>  '.$Recette['nom_rec'].'   </td>
				<td>  '.$Recette['type_rec'].' </td>
				<td> '. $Recette['ingredient_rec'].' </td>
...
<button class="btn btn-info"><a href="modifierRecette.php? ach='.$Recette['id'].'" class="text-light">Modifier</a></button>
<button class="btn btn-danger"><a href="supprimerRecette.php? deletevar='.$Recette['id'].'" class="text-light">Delete</a></button>
