...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="#" class="links"> <i class="fas fa-envelope"></i> midi.zine@esprit.tn </a>
            <a href="#" class="links"> <i class="fas fa-map-marker-alt"></i> Ariana, Tunisie - 400104 </a>
        </div>
        ...
        <form action="ajoutRec.php" method="POST">
            <div class="box">
                <h3>Reclamation</h3>
                <p>Contenu</p>
