            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Gestion des Sponsorss</h4>
                    </div>
...
<label for="exampleInputPassword1" class="">id_Sponsors:</label >
  ...
  <div class="">
    ...
    <input type="text"  name="Nom_Sponsors" class="form-control" id="Nom_Sponsors" required minlength="3" maxlength="20" size="10">
    <span id_Sponsors="cmon" style="color:#FF0000"> </span>
    <br>
    </div>
  <div class="">
    <label for="exampleInputPassword1" class="">Marque:</label>
    <input type="text"  name="Marque" class="form-control" id="">
    <span id_Sponsors="error" style="color:#FF0000"> </span>
  </div>
    <div class="">
