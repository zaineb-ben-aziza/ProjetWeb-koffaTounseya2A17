...
$verif=$utilisateurC->verifutilisateur($_POST["email"],$_POST["password"]); 

    
    if ($verif==1)
    {
     
        $listeadmin=$utilisateurC->getclient($_POST["email"],$_POST["password"]);
        foreach($listeadmin as $Util){
            if ($Util['type']=="client")
        header ("Location:client_login.php?id=".$Util['id']);    
        else 
        header ("Location:admin_login.php?id=".$Util['id']);    
        }
        
    }
    else 
    {
       echo'<script type="text/javascript"> alert ("invalid email ou password") </script>';
    ...
    <div class="shopping-cart">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <span class="quantity"><?php $ingredientC=new ingredientC(); echo $ingredientC->geting(1);  ?></span>
            </div>
        </div>
        <div class="box">
            <i class="fas fa-trash"></i>
            ...
            <div class="content">
                ...
                <span class="quantity"><?php $ingredientC=new ingredientC(); echo $ingredientC->geting(4);  ?></span>
            </div>
        </div>
        <div class="box">
            <i class="fas fa-trash"></i>
            ...
            <div class="content">
                <h3>carotte</h3>
                <span class="quantity"><?php $ingredientC=new ingredientC(); echo $ingredientC->geting(2);  ?></span>
            </div>
        </div>
        <div class="total"> total : $19.69/- </div>
        <a href="view12.php" class="btn">Confirmer</a>
    </div>

    <form action="" class="login-form" name="f" method="POST">
        <h3>login now</h3>
        ...
        <p>don't have an account <a href="create_now.php">create now</a></p>
...
<section class="products" id="products">
    ...
    <div class="swiper product-slider">
        ...
        <?php
         ...
         if(isset($_GET['test']))
            $ingredientC->ajouterpanier2($_GET['test']);
...
<p class="price">Quantité: <?php echo $ingredient["qteing"]; ?></p>
                <div class="price">
                <br>
                <button class="btn btn-info"> <a href='front.php?test=<?php  echo $ingredient["codeing"]; ?> '>Ajouter au panier</a></button>
